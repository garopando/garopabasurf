...
const LAT = -28.105132
const LON = -48.635622
const FOTO = 'https://www.garopabaimbituba.tur.br/wp-content/uploads/2021/05/ouvidor-4-e1620216908136.jpg'
const MAPS_URL = 'https://www.google.com/maps/dir/?api=1' + '&' + 'destination=-28.105132,-48.635622'
...
export default function PraiaPag() {
  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <div style={{ width: '100%', height: '300px', position: 'relative', overflow: 'hidden' }}>
        <img src={FOTO} alt='Praia do Ouvidor' style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </div>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px 16px 60px' }}>
        ...
        <h1 className={lexend.className} style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-0.06em', color: 'black', WebkitTextStroke: '0.5px black', marginBottom: '4px' }}>Praia do Ouvidor</h1>
        ...
        <h1 className={lexend.className} style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-0.06em', color: 'black', WebkitTextStroke: '0.5px black', marginBottom: '4px' }}>Ouvidor</h1>
        <p style={{ color: '#9ca3af', fontSize: '13px', marginBottom: '24px' }}>Garopaba, Santa Catarina</p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {dados.daily.wave_height_max.map(function(alturaMax, i) {
              const tempAgua = dados.hourly.sea_surface_temperature && dados.hourly.sea_surface_temperature[i * 24 + 12]
                ? fmt(dados.hourly.sea_surface_temperature[i * 24 + 12], 1) : null
              return <CardDia key={i} i={i} alturaMax={alturaMax} dados={dados} dadosMeteo={dadosMeteo} tempAgua={tempAgua} />
            })}
          </div>
        )}
