...
const LAT = -28.075091
const LON = -48.624343
const FOTO = 'https://radioestacaogaropaba.com/wp-content/uploads/2026/03/DJI_20260218084656_0125_D-1024x576.jpg'
const MAPS_URL = 'https://www.google.com/maps/dir/?api=1' + '&' + 'destination=-28.075091,-48.624343'
  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <div style={{ width: '100%', height: '300px', position: 'relative', overflow: 'hidden' }}>
        <img src={FOTO} alt='Ferrugem Norte' style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </div>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px 16px 60px' }}>
        ...
        <h1 className={lexend.className} style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-0.06em', color: 'black', WebkitTextStroke: '0.5px black', marginBottom: '4px' }}>Ferrugem Norte</h1>
