...
const LAT = -28.081375
const LON = -48.627925
const FOTO = 'https://www.waves.com.br/wp-content/uploads/2020/11/Bernardo-Villanueva-Praia-da-ferrugem-2-1024x683.jpg'
const MAPS_URL = 'https://www.google.com/maps/dir/?api=1' + '&' + 'destination=-28.081375,-48.627925'
  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <div style={{ width: '100%', height: '300px', position: 'relative', overflow: 'hidden' }}>
        <img src={FOTO} alt='Ferrugem Sul' style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </div>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px 16px 60px' }}>
        ...
        <h1 className={lexend.className} style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-0.06em', color: 'black', WebkitTextStroke: '0.5px black', marginBottom: '4px' }}>Ferrugem Sul</h1>
