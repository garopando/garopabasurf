...
const LAT = -27.959332
const LON = -48.624417
const FOTO = 'https://static.ndmais.com.br/2020/12/Mirante-Praia-da-Gamboa.-Foto_-Prefeitura-Municipal-de-Garopaba_Divulgação-scaled.jpg'
const MAPS_URL = 'https://www.google.com/maps/dir/?api=1' + '&' + 'destination=-27.959332,-48.624417'
  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <div style={{ width: '100%', height: '300px', position: 'relative', overflow: 'hidden' }}>
        <img src={FOTO} alt='Gamboa' style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </div>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px 16px 60px' }}>
        ...
        <h1 className={lexend.className} style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-0.06em', color: 'black', WebkitTextStroke: '0.5px black', marginBottom: '4px' }}>Gamboa</h1>
