...
const LAT = -28.035384
const LON = -48.603403
const FOTO = 'https://www.waves.com.br/wp-content/uploads/2018/10/12-Praia-do-silveira-foto-AiltonSouzaPhotography.jpg'
const MAPS_URL = 'https://www.google.com/maps/dir/?api=1' + '&' + 'destination=-28.035384,-48.603403'
  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <div style={{ width: '100%', height: '300px', position: 'relative', overflow: 'hidden' }}>
        <img src={FOTO} alt='Silveira Norte' style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
      </div>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px 16px 60px' }}>
        ...
        <h1 className={lexend.className} style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-0.06em', color: 'black', WebkitTextStroke: '0.5px black', marginBottom: '4px' }}>Silveira Norte</h1>
