...
export default function Newsletter() {
  return (
    <section className='w-full py-16 bg-gray-100'>
      <div className='max-w-[70%] mx-auto flex items-center justify-between gap-12'>
        <div className='flex flex-col gap-2'>
          ...
          <p className='text-gray-500 text-sm mt-1'>Previsoes, noticias e muito mais direto no seu email.</p>
        </div>
        <div className='flex gap-3 w-full max-w-md'>
          ...
          />
          <button className='bg-black text-white px-6 py-3 rounded-xl font-bold hover:bg-gray-800 transition text-sm whitespace-nowrap'>
            Inscrever-se
          </button>
        </div>
      </div>
